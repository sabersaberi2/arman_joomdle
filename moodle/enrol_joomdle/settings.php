...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('enrol_joomdle/currency', get_string('currency', 'enrol_joomdle'), '', get_string('iranian_rial', 'enrol_joomdle'), $paypalcurrencies));// mahdi agnelli
