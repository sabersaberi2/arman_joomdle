...
class joomdle_helpers_external extends external_api {
                    ...
                    'teachers' => new external_multiple_structure(
                        new external_single_structure(
                           array(
							  ...
							  'lastname' => new external_value(PARAM_TEXT, 'teacher lastname'),
							  'username' => new external_value(PARAM_TEXT, 'teacher username'),
                              'coursecounter' => new external_value(PARAM_INT, 'number of teacher\'s courses'),
                           )
                        )
                    ),
					// } mahdi agnelli
        ...
        return new external_multiple_structure(
            new external_single_structure(
                array(
                  ...
                  'lastname'      => new external_value(PARAM_TEXT, 'lastname'),
                  'username'      => new external_value(PARAM_TEXT, 'username'),
				  'courseid'      => new external_value(PARAM_TEXT, 'course id'), // mahdi agnelli
				  'coursecounter' => new external_value(PARAM_TEXT, 'course counter'), // mahdi agnelli
                )
            )
        );
    }
    ...
    public static function teacher_courses_parameters() {
        return new external_function_parameters(
                        array(
                            'username' => new external_value(PARAM_TEXT, 'Teacher username'),
                            'mod'      => new external_value(PARAM_TEXT, 'Type of courses information : summary or full', VALUE_DEFAULT, 'summary'), // mahdi agnelli
                        )
        );
    }
        ...
        return new external_multiple_structure(
            new external_single_structure(
                array(
                  ...
                  'cat_id' => new external_value(PARAM_INT, 'category id'),
                  'cat_name' => new external_value(PARAM_TEXT, 'category name'),
                  // mahdi agnelli : FROM get_course_info_returns{
                  'cat_description' => new external_value(PARAM_RAW, 'category description', VALUE_DEFAULT, ''),
                  'sortorder' => new external_value(PARAM_TEXT, 'category name', VALUE_DEFAULT, ''),
                  'shortname' => new external_value(PARAM_TEXT, 'course name', VALUE_DEFAULT, ''),
                  'idnumber' => new external_value(PARAM_RAW, 'category name', VALUE_DEFAULT, ''),
                  ...
                  'numsections' => new external_value(PARAM_INT, 'number of sections', VALUE_DEFAULT, 0),
                  'lang' => new external_value(PARAM_RAW, 'lang', VALUE_DEFAULT, ''),
                  'cost' => new external_value(PARAM_FLOAT, 'cost', VALUE_OPTIONAL, VALUE_DEFAULT, ''),
                  'currency' => new external_value(PARAM_TEXT, 'currency', VALUE_OPTIONAL, VALUE_DEFAULT, ''),
                  'enrolstartdate' => new external_value(PARAM_INT, 'enrol start date', VALUE_OPTIONAL, VALUE_DEFAULT, 0),
                  'enrolenddate' => new external_value(PARAM_INT, 'enrol end date', VALUE_OPTIONAL, VALUE_DEFAULT, 0),
                  'enrolperiod' => new external_value(PARAM_INT, 'enrol duration', VALUE_OPTIONAL, VALUE_DEFAULT, 0),
                  'self_enrolment' => new external_value(PARAM_INT, 'self enrollable', VALUE_DEFAULT, 0),
                  'enroled' => new external_value(PARAM_INT, 'user enroled', VALUE_DEFAULT, 0),
                  'in_enrol_date' => new external_value(PARAM_BOOL, 'in enrol date', VALUE_DEFAULT, 0),
                  'guest' => new external_value(PARAM_INT, 'guest access', VALUE_DEFAULT, 0),
                  'teachers' => new external_multiple_structure(
                      new external_single_structure(
                         array(
                            'firstname' => new external_value(PARAM_TEXT, 'teacher firstname', VALUE_DEFAULT, ''),
                            'lastname' => new external_value(PARAM_TEXT, 'teacher lastname', VALUE_DEFAULT, ''),
                            'username' => new external_value(PARAM_TEXT, 'teacher username', VALUE_DEFAULT, ''),
                         )
                      )
                  ,'teachers firstname and lastname and username', VALUE_DEFAULT, ''),
                  'summary_files' => new external_multiple_structure(
                      new external_single_structure(
                         array(
                            'url' => new external_value(PARAM_TEXT, 'item url', VALUE_DEFAULT, ''),
                         )
                      )
                  ,'summary files url', VALUE_DEFAULT, ''),
                  // } mahdi agnelli
                )
            )
        );
    ...
    public static function teacher_courses($username, $mod) {
        global $CFG, $DB;

        $params = self::validate_parameters(self::teacher_courses_parameters(), array('username' => $username));

        $auth = new  auth_plugin_joomdle ();
        $id = $auth->teacher_courses ($username, $mod);
