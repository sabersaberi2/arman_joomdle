            ...
            if ($curso['summary']) {
                if (count ($curso['summary_files']))
                {
                    foreach ($curso['summary_files'] as $file) {
                        ...
                        echo '<img class="img" style="height:150px;width:100%" hspace="0" vspace="5" align="center" src="'.$file['url'].'" data-src="'.$file['url'].'" ><p style="margin: 0px;padding: 10px 0;text-align: center">';
                        if ($linkto == 'moodle')
                        {
                            if ($default_itemid)
                ...
                echo '<div class="modal-dialog waves-effect" style="cursor: crosshair;">';
                echo '<div class="modal-content">';
                echo '<div class="modal-header"><button class="close" type="button" data-dismiss="modal">×</button>';
				...
				echo '</div>';
				echo '<img class="modalimg" style="max-height: 250px;margin: 0 auto;display: block;" hspace="0" vspace="5" align="center" src="'.$file['url'].'" data-src="'.$file['url'].'" ><p style="margin: 0px;padding: 10px 0;text-align: center">';
                echo '<div class="modal-body" style="text-align-all: center">';
                ...
                echo '</div>';
                echo '</div>';
                echo '<div class="modal-footer"><button class="btn btn-default jf_waves_dark_20" type="button" data-dismiss="modal">بستن</button></div>';
            }
