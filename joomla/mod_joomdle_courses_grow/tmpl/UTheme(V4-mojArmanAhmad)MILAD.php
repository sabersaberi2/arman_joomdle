...
.firstrowcourses .imgwi_m{width:100%;height:130px;}
...
?>
                        ...
                        <div class="profnme<?php echo $course['cat_id']; ?> jf_linkhover jf_linkhover2 jf_col_fluid profnme" >
                            <?php if (!empty($teacher)): ?>
                                <a href="<?php if($teacher['username']){ echo JRoute::_("index.php?option=com_joomdle&view=teacher&username=".$teacher['username']."&Itemid=$teacherItemid");} ?>"><?php if($teacher['lastname']){ echo $teacher['lastname']; }?></a>
                            <?php else: ?>
...
?>
						...
						<?php else : ?>
                            <div class="jf_col_fluid joomdle_course_cost" style="color:#bbb5b5">
...
<?php
                                    ...
                                    echo '</h3>';
?>
									<div class="dateanddetail" style="font-size:10px;font-family:'IRANSansWeb'">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($){
            $('.owl-carousel-joomdlecourses-m<?php echo $module->id; ?>').slick({
                infinite: false,
                rtl: true,
                slidesToShow: <?php echo $number_default;?>,
                slidesToScroll: 1,
                autoplay: false,
                autoplaySpeed: 2000,
                adaptiveHeight: true,
                ...
                responsive: [{
                    breakpoint: 2000,
                    settings: {
                        slidesToShow: <?php echo $number_2000;?>,
                        slidesToScroll: 1
                    }
                },{
                    breakpoint: 1500,
                    settings: {
                        slidesToShow: <?php echo $number_1500;?>,
                        slidesToScroll: 1
                    }
                },{
                    breakpoint: 1300,
                    settings: {
                        slidesToShow: <?php echo $number_1300;?>,
                        slidesToScroll: 1
                    }
                },{
                    breakpoint: 1024,
                    settings: {
                        slidesToShow: <?php echo $number_1024;?>,
                        slidesToScroll: 1
                    }
                },{
                    breakpoint: 800,
                    settings: {
                        slidesToShow: <?php echo $number_800;?>,
                        slidesToScroll: 1
                    }
                },{
                    breakpoint: 500,
                    settings: {
                        slidesToShow: <?php echo $number_500;?>,
                        slidesToScroll: 1
                    }
                }]
            });
