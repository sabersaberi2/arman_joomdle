...
?>
    <div class="owl-carousel-joomdlecourses-1 owl-theme joomdlecourses<?php echo $moduleclass_sfx; ?>" style="display: block; margin: 0 auto;">
<?php
        $courseShowLimit = 0;
        if (is_array($courses))
            $courseCounter=0;
...
?>
            <div class="grid_4 last-column joomdle_course_columns">
                <div class="jf_card">
                    <div class="card-main" id="card-main_ma_<?php echo $courseCounter; ?>">
<?php
...
?>
                    ...
                    <div id="popover_container_<?php echo $courseCounter; ?>" data-course-id="<?php echo $courseCounter; ?>" class="MyModal MyFade" style="padding:10px; display: none;" tabindex="-1">
                        <div id="popover_dialog_<?php echo $courseCounter; ?>" class="MyModal-dialog waves-effect" style="cursor: crosshair;">
                            <div id="popover_content_<?php echo $courseCounter; ?>" class="MyModal-content" style="border-radius: 16px;padding-bottom: 20px;">
                                ...
                                <div id="popover_numsec_<?php echo $courseCounter; ?>" class="MyModalnumsec MyModalnumsec<?php echo $course['cat_id']; ?> jf_col_fluid ">
                                    <b id="popover_numsec_number_<?php echo $courseCounter; ?>"><?php echo $course['numsections']." جلسه"; ?></b>
                                </div>
...
<!--
    <script type="text/javascript">
        jQuery(document).ready(function($){
            $(".owl-carousel-joomdlecourses-1").owlCarousel({
                rtl:true,
                loop:true,
                nav:true,
                margin: 10,
...
-->
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($){
            $('.owl-carousel-joomdlecourses-1').slick({
                infinite: false,
                rtl: true,
                slidesToShow: 4,
                slidesToScroll: 1,
        ...
        jQuery(document).ready(function($){
            $('div[id^=card-main_ma_]').popover({
                ...
                content: function() {
                    // var $input = $( this );
                    // console.log($input);
                    return $("#popover_container_" + getID(this.id)).html();
                }
            });
            ...
            $('div[id^=card-main_ma_]').mouseenter(function() {
