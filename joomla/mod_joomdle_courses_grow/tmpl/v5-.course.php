...
<?php
                                    ...
                                    echo '<img class="img lazy-joomdlecourses-m'.$module->id.' courseslider" hspace="0" vspace="5" align="center" data-lazy="'.$summary_file['url'].'" >';
                        ...
                        <div id="popover_dialog_m<?php echo $module->id; ?>_<?php echo $courseCounter; ?>" class="MyModal-dialog waves-effect" style="cursor: crosshair;">
                            <div id="popover_content_m<?php echo $module->id; ?>_<?php echo $courseCounter; ?>" class="MyModal-content" style="border-radius: 16px;padding-bottom: 20px;">
                                ...
                                <div id="popover_summaryimg_m<?php echo $module->id; ?>_<?php echo $courseCounter; ?>" class="MyModalovimg<?php echo $course['cat_id']; ?> MyModalovimg">
                                    <img id="popover_summaryimg_img_m<?php echo $module->id; ?>_<?php echo $courseCounter; ?>" class="MyModalimg" style="display: block;" hspace="0" vspace="5" align="center" data-lazy="<?php echo $summary_file['url']; ?>" data-src="<?php echo $summary_file['url']; ?>" >
                                </div>
                                ...
                                <div id="popover_profimg_m<?php echo $module->id; ?>_<?php echo $courseCounter; ?>" class="MyModalprofimg">
                                    <img id="popover_profimg_img_m<?php echo $module->id; ?>_<?php echo $courseCounter; ?>" data-lazy="<?php echo $teacher_user_info['pic_url']; ?>">
                                </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($){
            $('div[id^=card-main_m<?php echo $module->id; ?>_]').popover({
                ...
                placement: 'right',
                container: 'body',
                template: '<div id="popover_m<?php echo $module->id; ?>" class="popover" onmouseleave="$(this).hide();"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>',
