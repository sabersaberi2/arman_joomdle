...
<?php
                ...
                echo '<div class="modal-content" style="border-radius: 20px 20px 0px 0px;">';
                echo '<div class="modal-header" style="position:absolute;z-index:110;"><button class="close" type="button" data-dismiss="modal">×</button>';
