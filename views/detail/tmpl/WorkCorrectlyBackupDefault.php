...
<div class="jf_col_fluid joomdle-coursedetails<?php
echo $this->pageclass_sfx;
?>">
<div class="jf_col_fluid course_fullname" style="text-align:center;"><?php
echo $course_info['fullname'];
?></div>
<div class="jf_col_fluid course_summary" style="text-align:center;"><?php
...
<?php
								...
								$user_info = array_combine(array_map(function($old_user_info_k, $old_user_info_v)
								{
												...
												if (strncmp($old_user_info_k, 'cf_', 3) == 0) {
																$db    = JFactory::getDbo();
																$query = 'SELECT joomla_field' . ' FROM #__joomdle_field_mappings' . " WHERE moodle_field = " . $db->quote($old_user_info_k);
																$db->setQuery($query);
...
?>
                            <div class="flex-col wi-lg-25 wi-md-33 wi-sm-100 wi-xs-100 infoWrap" >
							  ...
							  <div class="row span8" style="padding:10px;">
...
?>
                    ...
                    <div style="display:none;">
                        ...
                        <div class="jf_col grid_6 last-column" style="flex:1;">
                            <div class="jf_col_fluid " style="text-align:center;"><?php
																echo strip_tags($this->course_info["cat_description"]);
?></div>
                            <div class="jf_col_fluid " style="text-align:center;">
                                <div class="jf_col grid_3">
                                    ...
                                    <div><?php
																echo $course_info['cat_name'];
?></div>
                                </div>
                                <div class="jf_col grid_3">
                                   <!--  <i class="material-icons" >picture_in_picture</i> -->
                                    <div><?php
																echo JText::_('COM_JOOMDLE_CERTIFICATE_ISSUANCE');
?></div>
                                </div>
                                <div class="jf_col grid_3">
                                  <!--   <i class="material-icons" >date_range</i> -->
                                    <div><?php
																echo JHtml::_('date', date('Y-m-d', $course_info['startdate']), JText::_('DATE_FORMAT_LC1'));
?></div>
                                </div>
...
?>
                                    <?php
																				if (array_key_exists('enrolperiod', $course_info)):
?>
...
<div class="span12 joomdle_course_links" style="margin-right:0px; float: right;">
<?php
								...
								if ($linkstarget == "new")
												...
												$target = "";
?>
    <div class="jf_col_fluid joomdle-course<?php
								echo $this->pageclass_sfx;
?>">
    <div class="panel-group" id="joomdle_accordion_v<?php
								echo $this->pageclass_sfx;
...
<!--
                <div class="jf_toggle light-blue">
                    <?php
																if ($show_topics_numbers):
?>
                        <div class="trigger jf_waves_light_30 waves-effect waves-light-30" data-toggle="collapse" data-target="#joomdle_item_content_<?php
																				echo $i;
...
?>
                    <div id="joomdle_item_content_<?php
																echo $i;
?>" class="container">
<?php
																if ($show_summary_course_view)
...
-->
                ...
                <div class="panel panel-default">
                    <a class="joomdle_accordion_v<?php
																echo $this->pageclass_sfx;
?>" role="button" data-toggle="collapse" data-parent_="#joomdle_accordion_v<?php
																echo $this->pageclass_sfx;
?>" href="#joomdle_section_content_<?php
																echo $i;
?>" aria-expanded="false" aria-controls="joomdle_section_content_<?php
																echo $i;
?>">
                        <div class="panel-heading" role="tab" id="joomdle_section_heading_<?php
																echo $i;
?>">
...
?>
                    ...
                    <div id="joomdle_section_content_<?php
																echo $i;
?>" class="panel-collapse collapse in_" role="tabpanel" aria-expanded="false" aria-labelledby="joomdle_section_heading_<?php
																echo $i;
?>">
...
<?php
																				...
																				foreach ($resources as $id => $resource):
?>
                                    <li class="list-group-item list-group-item-striped-<?php
																								echo $j % 2;
?>">
<?php
...
"><span class="sr-only">افزودن به علاقه مندی</span><span class="wishlist-button--status-text--2wu8d">افزودن به علاقه مندی</span><span class="glyphicon glyphicon-heart-empty
" style="
    font-size: 50px;
"></span></button>
<div class="ud-component--clp--gift-this-course" ng-non-bindable="" style="
    ...
    color: white;
"><div><a class="gift-this-course--gift-this-course__link--3TaW-" data-purpose="gift-course" href="/gift/the-web-developer-bootcamp/?couponCode=MOTHERSDAYSL2" style="
    color: white;
"><span>هدیه این دوره</span><span class="glyphicon glyphicon-gift" style="
    font-size: 49px;
"></span></a></div></div>
			
				                        <div class="course_detail_price jf_col grid_6 " style="flex:1;    width: auto;">
                            <img id="Mbanner" align="left" class="course_pic" src="<?php
								echo $file['url'];
?>" >
                            <div class="joomdle_course_buttons" style="text-align: center;margin:10px auto 0;">
                                <?php
								echo JoomdleHelperSystem::actionbutton($course_info, $free_courses_button, $paid_courses_button);
?>
                            </div>
...
?>
                        <div class="jf_col_fluid joomdle_course_language" >
                            <b><?php
																				echo JText::_('COM_JOOMDLE_LANGUAGE');
?>:&nbsp;</b><?php
																				echo JoomdleHelperContent::get_language_str($course_info['lang']);
?>
                        </div>
                    <?php
																endif;
...
?>
                    <div class="jf_col_fluid joomdle_course_startdate" >
                        <b><?php
																echo JText::_('COM_JOOMDLE_START_DATE');
?>:&nbsp;</b>
                        <?php
																echo JHtml::_('date', date('Y-m-d', $course_info['startdate']), JText::_('DATE_FORMAT_LC1'));
?>
...
?>
                    <?php
																if ((array_key_exists('enrolstartdate', $course_info)) && ($course_info['enrolstartdate'])):
?>
                        <div class="jf_col_fluid joomdle_course_enrolstartdate">
                            <b><?php
																				echo JText::_('COM_JOOMDLE_ENROLMENT_START_DATE');
?>:&nbsp;</b>
                            <?php
																				echo JHtml::_('date', date('Y-m-d', $course_info['enrolstartdate']), JText::_('DATE_FORMAT_LC1'));
?>
                        </div>
                    <?php
																endif;
?>
                    ...
                    <?php
																if ((array_key_exists('enrolenddate', $course_info)) && ($course_info['enrolenddate'])):
?>
                        <div class="jf_col_fluid joomdle_course_enrolenddate">
                            <b><?php
																				echo JText::_('COM_JOOMDLE_ENROLMENT_END_DATE');
?>:&nbsp;</b>
                            <?php
																				echo JHtml::_('date', date('Y-m-d', $course_info['enrolenddate']), JText::_('DATE_FORMAT_LC1'));
?>
                        </div>
                    <?php
																endif;
...
?>
                        <div class="jf_col_fluid joomdle_course_enrolperiod">
                            <b><?php
																				echo JText::_('COM_JOOMDLE_ENROLMENT_DURATION');
?>:&nbsp;</b><?php
																				if ($course_info['enrolperiod'] == 0)
																								echo JText::_('COM_JOOMDLE_UNLIMITED');
																				else
...
?>
                        <div class="jf_col_fluid joomdle_course_cost">
                            <b><?php
																				echo JText::_('COM_JOOMDLE_COST');
?>:&nbsp;</b><?php
																				echo $course_info['cost'] . " (" . (JText::_('COM_JOOMDLE_CURRENCY_' . $course_info['currency']) == 'COM_JOOMDLE_CURRENCY_' . $course_info['currency'] ? $course_info['currency'] : JText::_('COM_JOOMDLE_CURRENCY_' . $course_info['currency'])) . ")";
?>
                        </div>
                    <?php
																endif;
...
?>
                <?php
												if ($show_topicsnumber):
?>
                    <div class="jf_col_fluid joomdle_course_topicsnumber">
                        <b><?php
																echo JText::_('COM_JOOMDLE_TOPICS');
?>:&nbsp;</b><?php
																echo $course_info['numsections'];
?>
                    </div>
                <?php
												endif;
...
<?php
if ($this->params->get('show_back_links')):
?>
    <div>
        <P align="center">
            <a href="javascript: history.go(-1)"><?php
				echo JText::_('COM_JOOMDLE_BACK');
?></a>
        </P>
    </div>
<?php
